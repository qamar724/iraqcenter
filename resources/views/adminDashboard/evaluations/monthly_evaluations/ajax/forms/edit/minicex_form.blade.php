{{-- Mini-CEX IMIP Evaluation Form - EDIT MODE --}}
  ...
  <div class="custom-modal-body evaluation-form-body">
    ...
    <table class="evaluation-table info-table">
      ...
      <tr id="patient_data_row">
        ...
        <td class="value-cell">
          <span class="patient-data-inline">
            Age: <input type="number" class="form-control-inline" id="patient_age" name="patient_age" style="width: 80px; display: inline-block;" min="0" max="150" />
            &nbsp;&nbsp;
            Sex: <input type="text" class="form-control-inline" id="patient_sex" name="patient_sex" style="width: 80px; display: inline-block;" />
          </span>
        </td>
      </tr>
      ...
      <tr id="clinical_problem_row">
        ...
        <td class="value-cell">
          <input type="text" class="form-control" id="clinical_problem" name="clinical_problem"/>
        </td>
      </tr>
    </table>
    ...
    <div id="minicex_time_section">
      <table class="evaluation-table">
        <tr>
          <td><strong>Mini-CEX time:</strong> Observing: <input type="text" class="form-control-inline" id="minicex_observing_mins" style="width: 60px;"> Mins.</td>
          <td>Providing Feedback: <input type="text" class="form-control-inline" id="minicex_feedback_mins" style="width: 60px;"> Mins</td>
        </tr>
      </table>
      ...
      <table class="evaluation-table complexity-table">
        <tr>
          ...
          <td class="complexity-option"><label><input type="radio" name="minicex_complexity" value="low"> Low</label></td>
          <td class="complexity-option"><label><input type="radio" name="minicex_complexity" value="moderate"> Moderate</label></td>
          <td class="complexity-option complexity-high"><label><input type="radio" name="minicex_complexity" value="high"> high</label></td>
        </tr>
      </table>
      ...
      <div class="global-rating-section">
        ...
        <table class="evaluation-table competency-table">
          ...
          <tr>
            <td><input type="radio" name="minicex_global_competency" value="not_competent"></td>
            <td><input type="radio" name="minicex_global_competency" value="competent"></td>
          </tr>
        </table>
      </div>
      ...
      <div class="text-section">
        ...
        <textarea class="form-control" id="assessor_comments" name="assessor_comments" rows="4"></textarea>
      </div>
    </div>
