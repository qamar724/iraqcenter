{{-- DOPS IMIP Evaluation Form - VIEW MODE --}}
  ...
  <div class="custom-modal-body evaluation-form-body">
    ...
    <div id="dops_independent_practice">
      ...
      <div class="independent-practice-options">
        <label class="checkbox-option">
          <input type="checkbox" name="unable_perform_procedure" id="unable_perform_procedure" value="1" disabled> 
          Unable to perform procedure
        </label>
        <label class="checkbox-option">
          <input type="checkbox" name="able_perform_procedure" id="able_perform_procedure" value="1" disabled> 
          Able to perform the procedure under direct supervision/assistance
        </label>
        <label class="checkbox-option">
          <input type="checkbox" name="trained_and_competent" id="trained_and_competent" value="1" disabled> 
          Trained and competent in skills lab (this does not equate to clinical competence)
        </label>
        <label class="checkbox-option">
          <input type="checkbox" name="able_perform_procedure_limited" id="able_perform_procedure_limited" value="1" disabled> 
          Able to perform the procedure with limited supervision/assistance
        </label>
        <label class="checkbox-option">
          <input type="checkbox" name="competent_perform_procedure_unsupervised" id="competent_perform_procedure_unsupervised" value="1" disabled> 
    ...
    <div id="dops_feedback_after_signature">
      <div class="text-section">
        ...
        <textarea class="form-control" id="dops_aspects_done_well" name="dops_aspects_done_well" rows="4" readonly disabled></textarea>
      </div>
      ...
      <div class="text-section">
        ...
        <textarea class="form-control" id="dops_suggested_improvement" name="dops_suggested_improvement" rows="4" readonly disabled></textarea>
      </div>

      <div class="text-section">
        <label><strong>Agreed action plan:</strong></label>
        <textarea class="form-control" id="dops_agreed_action_plan" name="dops_agreed_action_plan" rows="4" readonly disabled></textarea>
      </div>
    </div>
