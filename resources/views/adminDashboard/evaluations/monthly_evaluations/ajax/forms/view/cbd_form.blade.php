{{-- CBD IMIP Evaluation Form - VIEW MODE --}}
  ...
  <div class="custom-modal-body evaluation-form-body">
    ...
    <table class="evaluation-table info-table">
      ...
      <tr id="cbd_title_row">
        ...
        <td class="value-cell">
          <input type="text" class="form-control" id="cbd_title" name="cbd_title" readonly disabled/>
        </td>
      </tr>
    </table>
    ...
    <div id="cbd_feedback_section">
      <div class="feedback-section">
        ...
        <table class="evaluation-table feedback-table">
          <tr>
            ...
            <td class="feedback-input"><input type="text" class="form-control" id="time_discussion" name="time_discussion" readonly disabled/></td>
          </tr>
          <tr>
            <td class="feedback-label">Time taken for feedback:</td>
            <td class="feedback-input"><input type="text" class="form-control" id="time_feedback" name="time_feedback" readonly disabled/></td>
          </tr>
        </table>
      </div>
      ...
      <div class="text-section">
        ...
        <textarea class="form-control" id="aspects_done_well" name="aspects_done_well" rows="4" readonly disabled></textarea>
      </div>
      ...
      <div class="text-section">
        ...
        <textarea class="form-control" id="suggested_improvement" name="suggested_improvement" rows="4" readonly disabled></textarea>
      </div>
    </div>
