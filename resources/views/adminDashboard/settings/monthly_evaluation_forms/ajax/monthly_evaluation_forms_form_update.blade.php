...
<div class="modal-footer" >        
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="ConfirmUpdateData_monthly_evaluation_forms()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
