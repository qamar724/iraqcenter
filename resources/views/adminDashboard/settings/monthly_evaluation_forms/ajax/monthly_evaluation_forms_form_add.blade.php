...
<div class="row">
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_monthly_evaluation_forms_name")}}</label>
...
<div class="modal-footer" id="modal-footer">     
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="monthly_evaluation_forms_ConfirmInsertData()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
