...
<div class="row">
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_university_major_name_en")}}</label>
...
<div class="row">
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_university_major_name_ar")}}</label>
...
<div class="modal-footer" id="modal-footer">     
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="university_major_ConfirmInsertData()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
