...
@php
 ...
 @endphp
  ...
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_city_name_en")}}</label>
  ...
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_city_name_ar")}}</label>
...
<div class="modal-footer" >        
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="ConfirmUpdateData_city()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
