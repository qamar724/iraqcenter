...
@php
 ...
 @endphp
  ...
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("settings.settings_category_procedure_name")}}</label>
...
<div class="modal-footer" >        
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="ConfirmUpdateData_category_procedure()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
