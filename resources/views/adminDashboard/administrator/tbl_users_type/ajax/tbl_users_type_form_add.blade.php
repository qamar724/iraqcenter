...
<div class="row">
  <div class="form-group row col-lg-12">
    <div class="col-lg-12">
     <label>{{__("administrator.administrator_tbl_users_type_name")}}</label>
...
<div class="modal-footer" id="modal-footer">     
   <button   type="button"  id = "Save" name = "Save"  class="btn   btn btn-primary"    onclick="tbl_users_type_ConfirmInsertData()"   > <i class="loader fa  "></i>  {{  __("public.save") }}   </button>
