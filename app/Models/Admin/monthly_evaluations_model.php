...
//7878454545  
class monthly_evaluations_model extends Model
 {
  use LogsActivity;
  protected static $logName = "monthly_evaluations";
  public $table ="monthly_evaluations";
  protected $fillable = [
  "id", 
  "users_id", 
 ...
 $request["hospitals_has_specialties_id"]  = decrypt($request["hospitals_has_specialties_id"]);
  ...
  {
     return LogOptions::defaults()->useLogName("monthly_evaluations")->logOnly(["*"]);
  }
} 
